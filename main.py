...
# 6. Filter columns
column_keep = ['study_focus', 'platform', 'device', 'technique', 'technique_sub', 'software_modeling'] + ['elo','cluster']
df_filter = keep_columns_csv(read_csv(PATH_DATA_CLUSTER), COLUMNS_METADATA, column_keep)
save_csv(df_filter, PATH_DATA_FILTER)
print_summary(read_csv(PATH_DATA_FILTER), COLUMNS_METADATA)
