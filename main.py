...
PATH_DATA_TRIM        = 'data/DATA_TRIM.csv'
...
df_trim = keep_columns_csv(read_csv(PATH_DATA_CLUSTER), COLUMNS_METADATA, column_keep)
save_csv(df_trim, PATH_DATA_TRIM)

# 8. Run models
X_train, X_test, y_train, y_test = split_dataset(
    df           = read_csv(PATH_DATA_TRIM), 
    test_size    = TEST_SIZE, 
    random_state = RANDOM_STATE, 
    column_drop  = ['elo', 'cluster'], 
    column_label = 'cluster'
